...
| --- | --- |
| **Termo** | **Significado** |
| **Atualização de Preços** | Tela do sistema onde você digita os valores das tarifas. |
| **Canal** | Plataforma de venda. Exemplos: Booking, Expedia, Decolar, site do hotel. |
| **Derivação** | Conexão entre duas tarifas onde uma calcula o valor da outra automaticamente. |
| **Percentual** | Tipo de cálculo usando porcentagem. Exemplos: 5%, 10%, 15%. |
| **Regra** | Definição de como a tarifa derivada será calculada (tipo, valor e direção). |
| **Suporte** | Equipe de ajuda técnica que configura a derivação no sistema. |
| **Tarifa** | Preço da hospedagem. Pode ser: normal, promocional, não reembolsável etc. |
| **Tarifa Base** | Tarifa principal que você digita manualmente. Também chamada de Tarifa Mãe. |
| **Tarifa Derivada** | Tarifa que recebe valor automaticamente. Aparece em cinza na tela. |
| **Valor Fixo** | Tipo de cálculo usando reais. Exemplos: R$ 10, R$ 20, R$ 50. |