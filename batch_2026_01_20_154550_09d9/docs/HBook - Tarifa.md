...
A tarifa é o plano de venda do seu hotel. Nela, você define apenas o preço, mas também as regras da reserva: quantas noites o hospede precisa ficar, com quanta antecedência ele deve reservar e quais são as regras caso ele precise cancelar.
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image13_a9b0d544.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image7_7dc48eea.png)

No canto inferior direto, possui um botão roxo com “+”, para criar

Tarifa.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_imaged_046757e1.png)

**4. Configurando a tarifa:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image10_1beb33da.png)

**5. Tipo de pensão:** Define qual refeição está incluída na tarifa. O usuário pode selecionar entre diferentes modalidades de pensão, de acordo com o que será oferecido ao hóspede. As opções disponíveis no sistema são:
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image16_e715325c.png)

**6. Configurações de disponibilidade:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image3_057daeee.png)

**Texto Descritivo:** Detalhes sobre características e informações relevantes sobre a tarifa.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_imagea_47e23df6.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_imageb_39a598c4.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_imagee_01126470.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image12_39cfee0c.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image14_5b762093.png)
...
### **10. Faixas de Penalidades de Cancelamento:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image5_8e0bb27b.png)

**12. Configurações de pagamento:**
...
**Todas as formas de pagamento são aceitas para esta tarifa:**

* **A**o selecionar essa opção, o sistema libera automaticamente todas as formas de pagamento habilitadas no hotel.

**Apenas as formas de pagamento selecionadas abaixo são aceitas para esta tarifa:**

* Permite escolher individualmente quais métodos estarão disponíveis.
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image6_b1ed9669.png)

**13. Dados de Parcelamento:**

* Se o hotel aceitar cartão de crédito, é possível configurar o parcelamento da reserva.

**14. Permite Parcelamento:**

* **H**abilita o recurso de parcelamento.

**15. Ocultar % de juros para o hóspede:**

* Ao marcar, o sistema aplica os juros, mas não exibe essa informação diretamente ao cliente.

**16. Aplicar percentual de juros de 1 parcela também para garantia:**

* Garante que, mesmo em caso de cobrança de apenas 1 parcela (como em pagamento de garantia), o percentual de juros configurado será aplicado.

**17. Tipo de parcelamento:**

* Define em qual meio o parcelamento será aplicado, cartão de crédito ou no hotel.

**18. Valor mínimo da parcela:**

* Campo numérico para definir um valor mínimo que cada parcela deve ter.

**19. Número máximo de parcelas:**

* **D**efine até quantas vezes a reserva poderá ser dividida.

**20. Configuração por parcela:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image8_e91fc368.png)
...
**22. Lista de Extras Disponíveis:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image17_24f423b7.png)

Por fim, clique no botão roxo, no canto inferior direto, para **salvar.**

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image2_2ad446fe.png)
...
24. Para acessar a tela basta acessar o Hbook, ir em **PROPRIEDADE → COMBINAÇÕES QUARTO/TARIFA**
...
**Sem derivação tarifária:**

* As tarifas serão associadas sem nenhum cálculo adicional. será considerado uma tarifa principal (independente).

**Com derivação tarifária:**

* Ao preencher esse campo, são exibidas as opções de configuração de **Percentual (%), Em valor e Em divisão**, que permitem ajustar a tarifa secundária em relação à tarifa master.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image_8bb3291e.png)

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image9_3b955afe.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_imagec_aaf4080a.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_imagef_0c07cde7.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image11_e4ded9de.png)

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image18_81965595.png)

**27. Campo Tarifa Master**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image4_6f5fbe89.png)

### **29. Informativo importante**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/HBook_-_Tarifa_image15_9eeb3cba.png)

**Glossário:**

|  |  |
| --- | --- |
| **Tarifa Master** | **É a sua tarifa “mãe”. Se voce mudar o preço dela, todas as outras tarifas ligadas a ela mudam automaticamente.** |
| **Pensão** | **Refere-se as refeições incluídas na diária (café, almoço ou jantar)** |
| **Check-box** | **São as pequenas caixas quadradas que você clica para marcar ou desmacar uma função.** |
| **Vincular** | **É o ato de ligar uma regra de preço (tarifa) a um tipo de dormitório (Quarto)** |
| **Last Minute** | **Termo em inglês para última hora, usado para reservas feitas muito próximas da data de chegada.** |