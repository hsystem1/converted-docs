...
**1. O que é a lista de reservas?**

* Imagine esta tela como o grande livro de registros do seu hotel, mas no computador. Nela você consegue ver todos os detalhes de quem reservou, quem cancelou e quem ainda vai chegar. É o lugar central para controlar o movimento dos seus hospedes.
...
**2. Como pesquisar uma reserva (Filtros):**

**Para não se perder entre muitos nomes, o sistema oferece filtros, que funcionam como lupas para encontrar exatamente o que você precisa.**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image_cfe3de1a.png)

**3. Dispositivos da reserva:** Por qual aparelho foi realizado a reserva do hospede.

* **Desktop**: Reserva feita por computador/notebook/pc;
* **Mobile**: Reserva feita por celular

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_imagea_f256b4ad.png)

**4. Somente reservas de:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image11_3c4befe0.png)

**5. Período:** Filtro de datas.
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image3_887ca194.png)

**6. Forma de pagamento:** Como o hóspede escolheu pagar a reserva.
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image4_b0eff850.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image6_7f3ab2b7.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_imagee_07263f34.png)
...
Botão **“Exportar E-mails”** = É possível extrair das reservas apenas uma listagem de email, geralmente para campanha de marketing.
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image7_318415e9.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image8_c8be2d22.png)

**8. Entendendo os Resultados da Busca:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_imageb_b78abe2d.png)

* **Hóspede**: nome e e-mail da pessoa que fez a reserva.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image13_74b74cfa.png)

* **Localidade**: país ou cidade de origem do hóspede.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image14_2abb5b23.png)

* **Tipo de Quarto**: categoria do quarto reservado, como “Suíte Standard Twin”.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image12_dc84ae1f.png)

* **Reservado**: data e hora em que a reserva foi feita.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image2_fc5e8cfb.png)

* **Período da Estadia**: mostra as datas de check-in e checkout.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image5_caf99c05.png)

* **Código Promocional**: campo usado caso o hóspede tenha aplicado um cupom de desconto.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image9_946f89b0.png)

* **Status**: indica se a reserva está *ativa ou cancelada*.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_imagec_fe30feec.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_imagef_ff5b880b.png)

* **Total**: valor total da reserva.

Obs.: O VALOR CONSIDERA TOTAL DA RESERVA, CONSIDERANDO DIÁRIAS, TAXAS E EXTRAS.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_image10_b1bd054b.png)

### **9. Resumo de Reservas**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_20_154550_09d9/images/Hbook_-_Lista_de_res_imaged_5c60868e.png)

**Glossário**

|  |  |
| --- | --- |
| **Voucher** | **É o comprovante de reserva. Como se fosse o bilhete do hospede.** |
| **Status** | É a situação atual de algo (ex: se está pago, se está cancelado). |
| **NoShow** | Termo em inglês para quando o hóspede tem uma reserva, mas não aparece no hotel e não avisa. |
| **Abandono de Carrinho** | Quando o cliente começa a fazer a reserva pela internet, mas desiste antes de clicar no botão final. |
| **HPay** | O sistema que processa os pagamentos com cartão de crédito dentro do seu site. |