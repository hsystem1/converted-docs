...
**O que são códigos Promocionais?**

Códigos promocionais são cupons de desconto que você cria para oferecer condições especiais aos hóspedes. É como criar um vale-desconto personalizado.
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Configurac%CC%A7o_image_bd196ebe.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Configurac%CC%A7o_image9_5ee4fd78.png)

**9.Configurando Código Promocional**

* Os campos e botões disponíveis permitem definir regras de uso, validade e restrições específicas de cada código.

**Gerar Link: Crie um** **link direto** deste código promocional. Esse link pode ser enviado ao hóspede e direciona para a tela pública do motor de reservas já com o código aplicado.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Configurac%CC%A7o_imageb_7803681b.png)

**10. Gerar em Massa: Crie vários códigos com a mesma configuração de uma vez. Os códigos terão números aleatórios automáticos.**

Os códigos gerados terão **IDs automáticos e aleatórios**, que **não podem ser editados** posteriormente.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Configurac%CC%A7o_image6_fdfa4d83.png)

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Configurac%CC%A7o_image7_269e9b9b.png)
...
Caso uma reserva feita com o **código** seja cancelada, a quantidade exibida neste campo é reduzida, refletindo apenas as utilizações ativas no momento.![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Configurac%CC%A7o_imagec_6919013c.png)

**12. Data de validade para utilização do código**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Configurac%CC%A7o_image4_9058febd.png)

**13. Período em que o hóspede poderá se hospedar utilizando este código:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Configurac%CC%A7o_image5_f7fc7aaf.png)

**14. Número de noites mínimas para que o código seja aceito**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Configurac%CC%A7o_image2_7bbda12e.png)

**15. Tarifas participantes**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Configurac%CC%A7o_image3_859a5936.png)

**17. Formas de pagamento liberadas quando utilizado o código**
...
**18. Revise todas as configurações e clique em SALVAR.**

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Configurac%CC%A7o_image8_02267210.png)

|  |  |
| --- | --- |
| **Termo** | **Significado** |
| **Agência** | Empresa parceira que vende reservas de hotéis. |
| **Agente Interno** | Funcionário do hotel que faz orçamentos e reservas. |
| **Código Promocional** | Cupom de desconto. Como um vale-presente com condições especiais. |
| **Desconto** | Redução no preço. Pode ser em % (percentual) ou em R$ (valor fixo). |
| **Estadia** | Período de hospedagem. Quantidade de noites no hotel. |
| **Estadia Mínima** | Menor número de noites permitido. Exemplo: mínimo 3 noites. |
| **Faturado** | Pagamento por fatura/boleto. Não paga na hora. |
| **HBOOK** | Motor de Reservas. Sistema de reservas online hotel. |
| **Link** | Endereço da internet. Você pode enviar por e-mail ao cliente. |
| **Oferta** | Promoção já ativa no sistema. Pode ser combinada com o código. |
| **Orçamento** | Proposta de preço. Simulação de quanto vai custar. |
| **Percentual** | Desconto em porcentagem. Exemplo: 10% significa R$10 a cada R$100. |
| **Tarifa** | Plano de preço. Exemplos: tarifa normal, promocional, grupo. |
| **Valor Absoluto** | Desconto em dinheiro fixo. Exemplo: R$ 50 de desconto. |