...
O Calendário é onde você gerencia todas as informações de disponibilidade, preços e regras de reserva do seu hotel. É dividido em 4 abas principais, cada uma com uma função específica.

**1. Como Acessar:**

* Acesse HBOOK -> Calendário

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image7_214c6965.png)

* **Você verá 4 abas:** Grade, Atualizar Disponibilidade, Atualizar Preços e Atualizar Restrições.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image15_ecb44693.png)
...
Importante: Caso queira ver datas passada, é necessário digitar a data no campo de calendário.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image16_4d9654cd.png)

**3. Estrutura da Tabela de Tarifas e Disponibilidade:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image2_d42d8307.png)

**4. Nome do Alojamento / Quarto / Cabana / Categoria** - Na primeira coluna da esquerda, aparecem os **nomes dos quartos**, que são as unidades disponíveis para reserva.

* Isso ajuda a identificar onde a tarifa está sendo aplicada

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image9_3d30999a.png)

**5. Plano Tarifário** - Logo abaixo do nome da acomodação, aparecem as **opções de tarifas** para reservar e quantidade de pessoas.
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_imageb_a03d6c87.png)

**6. Disponibilidade (estoque de unidades)** - O número que aparece no topo de cada linha (acima das tarifas, em cinza claro) mostra a **quantidade de unidades disponíveis** na categoria.

* Quando o número está **0 em vermelho**, significa que **não há disponibilidade para reserva**.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_imagee_ad3f6b1a.png)

**7. Valores Diários (tarifas)** - No corpo da tabela, aparecem os **valores cobrados por dia** para cada tipo de ocupação.
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image6_03e4da88.png)

**Legenda:**

* **Ocultar tarifas:** Serve para “esconder” os planos tarifários, preço e Pax. Deixar **somente as disponibilidades das categorias**.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image19_edeb2786.png)

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image_64e43e37.png)

* **Restrições:** Quando a opção **“restrições”** está marcada (check azul), aparecem campos adicionais, como:

**8. Estadia mínima** - Define o número mínimo de noites que o hóspede precisa reservar.
...
* Geralmente usados para evitar saídas no meio de pacotes ou em datas de alta movimentação.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image3_57602d6a.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_imagec_a90e31fb.png)
...
**13. Vantagens da tarifa derivada:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image12_f88889f5.png)

**14. Aba Atualizar disponibilidade:**
...
**15. Estrutura da tela de Disponibilidade:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image8_2afb06fc.png)

**16. Tipos de Quarto e Tarifas:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image10_22c74d3a.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image17_18fdec8b.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image1a_4d9654cd.png)

**18. Aba atualizar preço:**
...
**Ícone de "+" (Adicionar):** Geralmente usados para criar múltiplos períodos simultaneamente.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image4_ae5def73.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_imagea_5c2491c4.png)

**20.Valores por Tipo de Quarto:**
...
O sistema só permitirá preencher até o limite máximo de ocupação de cada tipo de quarto.
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_imaged_46109959.png)
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image13_3480e4de.png)

**22. Digite o valor (%) que deseja atribuir:** Não obrigatório, apenas se quiser enviar um valor diferente (a mais ou a menos) do que foi digitado nos campos te preço (em porcentagem).

O valor(preço) aplicado irá para venda com a porcentagem inserida, ou seja, aumenta ou diminui o valor que foi digitado.

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image14_1662b3fd.png)

Por fim, clicar no botão **“Atualizar”**

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image11_4094faf1.png)

**23. Aba Atualizar restrições:**
...
**24. Estrutura da tela de Atualização de restrições:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image18_48472c60.png)

**25. Tipos de Quarto e Tarifas:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image5_df3abc32.png)

**26. Restrições de tarifas:**
...
![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_imagef_9ac18c70.png)

Por fim, clicar no botão **“Atualizar”**

![Imagem](https://raw.githubusercontent.com/hsystem1/converted-docs/main/batch_2026_01_27_144114_87c5/images/Hbook_-_Calendario_image1b_3111aa27.png)
...
| --- | --- |
| **Termo** | **Significado** |
| **Calendário** | Área onde você gerencia disponibilidade, preços e regras de reserva. |
| **Check-in** | Entrada do hóspede no hotel. Dia que começa a hospedagem. |
| **Checkout** | Saída do hóspede do hotel. Dia que termina a hospedagem. |
| **Disponibilidade** | Quantidade de quartos livres disponíveis para reserva. |
| **Estadia Mínima** | Número mínimo de noites que o hóspede precisa reservar. |
| **Grade** | Aba de consulta. Mostra tudo em formato de tabela. |
| **HBOOK** | Motor de Reservas. Sistema onde clientes fazem reservas direto no site. |
| **HUNIT** | Channel Manager. Sistema que gerencia os canais de venda. |
| **Pax** | Quantidade de pessoas. Exemplo: 2 pax = 2 pessoas. |
| **Plano Tarifário** | Tipo de tarifa. Exemplos: normal, promocional, não reembolsável. |
| **PMS** | Sistema interno de gerenciamento do hotel. |
| **Restrição** | Regra especial aplicada nas reservas. Exemplos: estadia mínima, fechado para chegada. |
| **Stop de Vendas** | Bloqueio de vendas. Mesmo com quartos disponíveis, não aceita reservas. |
| **Tarifa** | Preço da diária. Valor cobrado por noite de hospedagem. |
| **Tarifa Derivada** | Tarifa calculada automaticamente com base em outra. Tem símbolo ∞. |